...
<![endif]-->
    ...
    <noscript>
      <style type="text/css">
        .layout-container, header, footer, .pdb-linksource.button {opacity:1}
      </style>
    </noscript>
  </head>
  <body  class="page-node-63 role-anonymous path-node not-front page-node-type-artikel frontend" data-edit-target="" data-edit-source="">
  ...
  <div class="Fixed modal fade" id="contactmessage-send-modal" tabindex="-1" role="dialog" aria-labelledby="maplabel">
      ...
      <div class="Fixed modal fade" id="application-send-modal" tabindex="-1" role="dialog" aria-labelledby="maplabel">
      <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
           <div class="modal-header light-font">
            <button type="button" class="icon kbtpe-icon-cancel" data-dismiss="modal" aria-label="Close"></button>
            <h4 class="modal-title">Merci beaucoup !</h4>
          </div>
          <div class="modal-body dark-font clearfix">
            <p>Votre message a été envoyé.</p>
            <button type="button" class="modal-close-text" data-dismiss="modal" aria-label="Close">clore</button>
	...
	<div class="clearfix">
		...
		<div id="header-container--navigation">
			<div id="header-container--navigation--subwrapper-1" class="clearfix">
				<div id="header-container--navigation--subwrapper-1--regions">
					<nav role="navigation" aria-labelledby="block-regionen-menu" id="block-regionen" class="block block-menu navigation menu--regionen">
            
  <h2 class="visually-hidden" id="block-regionen-menu">Regionen</h2>
				...
				<div id="header-container--navigation--subwrapper-1--quicklinks">
					<nav role="navigation" aria-labelledby="block-headerquicklinks-menu" id="block-headerquicklinks" class="block block-menu navigation menu--header-quicklinks">
            
  <h2 class="visually-hidden" id="block-headerquicklinks-menu">Header Quicklinks</h2>
			...
			<div id="header-container--navigation--subwrapper-2" class="clearfix">
				<div id="header-container--navigation--subwrapper-2--hauptnavigation" class="col-md-16">
			 ...
			 <svg class="ripple-obj">
				<use width="100" height="100" xlink:href="#ripply-scott" class="js-ripple"></use>
											...
											<a href="https://www.kraiburg-tpe.com/fr/qualite" class="uppercase fontweight-bold tpe-link" data-drupal-link-system-path="node/62">Qualité</a>
																			...
																			<li class="parent dropdown clearfix noselect level-0">
											<span  class="nolink noselect uppercase fontweight-bold tpe-link dropdown-toggle" data-toggle="dropdown" ="&lt;front&gt;">Marchés</span>
			 ...
			 <svg class="ripple-obj">
				<use width="100" height="100" xlink:href="#ripply-scott" class="js-ripple"></use>
											...
											<a href="https://www.kraiburg-tpe.com/fr/technologie-medicale" class="uppercase fontweight-bold tpe-link" data-drupal-link-system-path="node/9">Technologie médicale</a>
																			...
																			<li class="parent active-li dropdown clearfix noselect level-0">
											<span  class="nolink noselect uppercase fontweight-bold tpe-link dropdown-toggle" data-toggle="dropdown" ="&lt;front&gt;">Produits</span>
			 ...
			 <svg class="ripple-obj">
				<use width="100" height="100" xlink:href="#ripply-scott" class="js-ripple"></use>
											...
											<a href="https://test.kraiburg-tpe.com/?ls=fr" class="uppercase fontweight-bold tpe-link">Recherche de produits</a>
																			...
																			<li class="parent dropdown clearfix noselect level-0">
											<span  class="nolink noselect uppercase fontweight-bold tpe-link dropdown-toggle" data-toggle="dropdown" ="&lt;front&gt;">Médias</span>
			 ...
			 <svg class="ripple-obj">
				<use width="100" height="100" xlink:href="#ripply-scott" class="js-ripple"></use>
											...
											<a href="https://www.kraiburg-tpe.com/fr/telechargements" class="uppercase fontweight-bold tpe-link" data-drupal-link-system-path="node/16">Téléchargements</a>
																			...
																			<li class="parent dropdown clearfix noselect level-0">
											<span  class="nolink noselect uppercase fontweight-bold tpe-link dropdown-toggle" data-toggle="dropdown" ="&lt;front&gt;">Carrière</span>
			 ...
			 <svg class="ripple-obj">
				<use width="100" height="100" xlink:href="#ripply-scott" class="js-ripple"></use>
											...
											<a href="https://www.kraiburg-tpe.com/fr/node/19" class="uppercase fontweight-bold tpe-link" data-drupal-link-system-path="node/19">Europe</a>
																			...
																			<li class="dropdown clearfix noselect level-1">
											<a href="https://newton.newtonsoftware.com/career/CareerHome.action?clientId=8a78826756b5dae60156e28ada850b81" class="uppercase fontweight-bold tpe-link">Amérique</a>
				...
				<div id="header-container--navigation--subwrapper-2--search" class="col-lg-6 col-md-8">
					...
					<span id="schnitzraum-search-icon" class="kbtpe-icon-search"></span>
  ...
  <span class="icon"></span><span class="label">Menu</span>
	...
	<div id="header-container--indicator" class="notransition"></div>
</header>
...
<div id="block-suche" class="block hidden">
	<div id="schnitzraum-search-wrapper">
		<span class="kbtpe-icon-cancel" id="close-search"></span> 
   	  	<div id="schnitzraum-search-filter" class="hidden">
   	  							    <div id="schnitzraum-search-type" class="clearfix">
		    	<div class="col-lg-6 col-sm-12 col-xs-24 filter-element">
		    		<div data-value="artikel" data-language="fr" class="toggle toggle-light" style="width:50px; display:inline-block;"></div> <span class="label">Article</span>
		    	</div>
		    	<div class="col-lg-6 col-sm-12 col-xs-24 filter-element">
		    		<div data-value="press" class="toggle toggle-light" style="width:50px; display:inline-block;"></div> <span class="label">Presse</span>
		    	</div>
				<div class="col-lg-6 col-sm-12 col-xs-24 filter-element">
		    		<div data-value="event" data-language="fr" class="toggle toggle-light" style="width:50px; display:inline-block;"></div> <span class="label">Evénements</span>
		    	</div>
				<div class="col-lg-6 col-sm-12 col-xs-24 filter-element">
		    		<div data-value="news" data-language="fr" class="toggle toggle-light" style="width:50px; display:inline-block;"></div> <span class="label">News</span>
		    	</div>
		    </div>
		</div>
		<h3 id="schnitzraum-no-types" class="hidden bigspace-wrapper">
	    	Aucun type de recherche sélectionné. 	    </h3>
	     <h3 id="schnitzraum-no-results" class="hidden bigspace-wrapper">
	    	Pas de résultats.
<br />
<br />
Vous avez des questions ou vous voulez en savoir plus ? Contactez-nous.
<br />
<a href="mailto:info@kraiburg-tpe.com" title="e-Mail senden">info@kraiburg-tpe.com</a>  /
<br />
+49 8638 9810-0 	    </h3>
	</div>
</div>
