...
$webseite_url = 'http://drupaldev.kraiburg-tpe.com';

$this_url = 'drupaldev.kraiburg-tpe.com/special/curl/login.php';
...
$str_getUrlContent = 'http://test.kraiburg-tpe.com/index.php?url=en/products/loginktpepdb-215' . $add_to_url;
