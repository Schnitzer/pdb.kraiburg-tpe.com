<?php
function cleanPdb____($str, $langshortcode = 'en')
{
  $str = str_replace('http://drupaldev.kraiburg-tpe.com/pdb/' . $langshortcode . '/products/product-database', 'https://test.kraiburg-tpe.com/?ls/' . $langshortcode, $str);
...
' . $str;
  ...
  $strs .= '<!--<script src="' . $db_url . '/core/assets/vendor/domready/ready.min.js?v=1.0.8"></script>-->
...
\t\t\t\t ";
  ...
  $strj .= '<script src="http://code.jquery.com/jquery-1.11.1.min.js"></script>
