...
ncw.layout.dateTimePicker = function () {
    ...
    $('.ncw-datepick').date_input({ start_of_week: 1 });
    $('.ncw-datepick-with-past').date_input({ start_of_week: 1 });
                            ...
                            function (data) {
                                ...
                                if (false == website_site_mode) {
                                    ncw.layout.statusMessage.hide(
                                        ...
                                        function () {
                                            if (true == data.return_value) {
                                                eval('if (typeof(ncw.' + rel[0] + '.' + rel[1] + '.reload) == "function") { ncw.' + rel[0] + '.' + rel[1] + '.reload("delete"); } ');
                                            }
                                        }
                                    );
                    ...
                    function (data) {
                        ...
                        ncw.layout.statusMessage.hide(
                            ...
                            function () {
                                ...
                                if (true == data.return_value) {
                                    eval('if (typeof(ncw.' + rel[0] + '.' + rel[1] + '.reload) == "function") { ncw.' + rel[0] + '.' + rel[1] + '.reload("new"); } ');
                                }
                            }
                        );                       
                    },
