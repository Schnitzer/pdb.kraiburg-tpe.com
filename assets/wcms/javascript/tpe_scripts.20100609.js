...
function search () 
{
    //var path = 'http://www.kraiburg-tpe.com';
    //var path = 'http://localhost/kraiburg-tpe';
    $.post(path + '/admin/wcms/website/search', $('#textsearchform').serialize(),
    function (data) {
        $('#ts_results').html('');
...
function region_search_country(region_id, label_country, label_forward, language)
{
    ...
    //var path = 'http://www.kraiburg-tpe.com';
    //var path = 'http://localhost/kraiburg-tpe';
	$.getJSON( path + '/admin/tpe/region/ajaxCountries/' + region_id + '/' + language,
        function(data){
            if (data.country) {
                str_options = '';
