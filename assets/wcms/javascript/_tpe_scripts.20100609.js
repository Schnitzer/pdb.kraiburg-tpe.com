...
function search() {
  $.post(
    'http://drupaldev.kraiburg-tpe.com/admin/wcms/website/search',
...
function region_search_country(region_id, label_country, label_forward, language) {
  ...
  $.getJSON('http://drupaldev.kraiburg-tpe.com/admin/tpe/region/ajaxCountries/' + region_id + '/' + language, function (data) {
    if (data.country) {
      str_options = '';
