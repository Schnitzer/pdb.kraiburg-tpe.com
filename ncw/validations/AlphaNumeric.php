<?php
/**
 * contains the AlphaNumeric validation class
 *
 * PHP Version 5.2
 ...
 * @link       http://www.netzcraftwerk.com
 */
class Ncw_Validations_AlphaNumeric extends Ncw_Validation
{
     ...
     * @var string
     */
    public $error_message = 'Only letters from A to Z and numbers from 0 to 9 are allowed!';
