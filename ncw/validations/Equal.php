<?php
/**
 * contains the Equal validation class
 *
 * PHP Version 5.2
 ...
 * @link       http://www.netzcraftwerk.com
 */
class Ncw_Validations_Equal extends Ncw_Validation
{
     ...
     * @var string
     */
    public $error_message = 'This value is not equal';

    /**
     * Checks if the value is equal to the given one
     *
     * @param mixed $value the value to check
     * @param mixed $equal the value to match
     *
     * @return boolean true or false
     */
    public function check ($value, $equal)
    {
        if ($value === $equal) {
            return true;
        }
        $this->error_message .= ' to ' . $equal . '!';
        return false;
    }
}
?>
