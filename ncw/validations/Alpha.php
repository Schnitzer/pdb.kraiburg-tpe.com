<?php
/**
 * contains the Alpha validation class
 *
 * PHP Version 5.2
 ...
 * @link       http://www.netzcraftwerk.com
 */
class Ncw_Validations_Alpha extends Ncw_Validation
{
     ...
     * @var string
     */
    public $error_message = 'Only letters from A to Z are allowed!';
    ...
    {
        if (true == preg_match('/^[A-Za-z]+$/', $value)) {
            return true;
        }
        return false;
    }
