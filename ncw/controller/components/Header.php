<?php
/**
 * Contains the Header component class
 *
 * PHP Version 5.2
 ...
 */
/**
 * Include the pear HTTP_Request Class.
 */
require_once 'ncw/vendor/pear/HTTP/Header.php';
/**
 * Header component. (Extends from the PEAR HTTP Header class.)
 *
 * @category   Netzcraftwerk
 * @package    Ncw
 * @subpackage Helper
 ...
 * @link       http://www.netzcraftwerk.com
 */
class Ncw_Components_Header extends Ncw_Component
{
