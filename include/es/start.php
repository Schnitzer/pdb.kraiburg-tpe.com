...
<link rel="stylesheet" media="all" href="https://www.kraiburg-tpe.com/sites/default/files/css/css_7yJp6iVU3bmLSBSuoFWX__-W9ucf6DQfInvq-hF_RmQ.css?delta=1&amp;language=es&amp;theme=schnitzraum&amp;include=eJx1kVFuwyAMQC-UhTNM2uf61QMgA17jlWBkmyXd6UeralHV9AfMe1g2Br5h9ZkhoTjY4tEm4RBQhoBmKB7XyorJf1HuR3UnLCiQB2w-Mp8J-zbXTFAiuj3oAwgOFQROAnVSl6RVyONGxlZqC5l0wjTUiY11oYpuC8fMsdfcgE-XAjNFH6EacXGv1T1X41TIfgXa7AKzqfXaB06v1BEzRntw_x2_x8iSkMu-_uClXKe5bz9J7YdwOdol4_6VAyaCwOujTeE5RZ9IU5S3O0aQOHmo5KEZ374EDd0LPuhFDfsIQHFooQ_w3PswFr9QOqGp24Njo-H6HHW3dZw5tYx_S1jyVA" />
...
<div class="js-view-dom-id-d0b304f3e1e3c009ad015d8a206db696c5a87fb2b1bbcce52a614cf16f03cd8d clearfix">
...
<div class="js-form-item form-item js-form-type-radio form-type-radio js-form-item-type form-item-type">
	...
	<div class="js-form-item form-item js-form-type-radio form-type-radio js-form-item-type form-item-type">
		<a href="https://test.kraiburg-tpe.com" target="_blank" class="label" uk-icon="chevron-right">Buscador de productos</a>
		<div></div>
</div>
  ...
  <h2 class="visually-hidden" id="block-headerquicklinks-menu">Quicklinks</h2>
							...
							<ul block="block-headerquicklinks" class="menu clearfix uk-list uk-list-collapse">
															...
															<a href="https://www.kraiburg-tpe.com/es/contacto" class="quicklinks-contact" data-drupal-link-system-path="node/11">Contacto</a>
																																					...
																																					<li data-grid-fullwidth="0" class="level-0">
															<a href="https://test.kraiburg-tpe.com/?searchheader=true&ls=es" class="pdb-linksource" target="_self">Búsqueda de productos</a>
																				</li>
												</ul>
	...
	<div class="uk-container">
		<div data-uk-navbar="dropbar: true; dropbar-anchor: !.uk-navbar-container; target-y: !.uk-navbar-container; mode: click" class="uk-flex-center uk-navbar">
								...
								<ul data-region="system" block="block-hauptnavigation" class="menu clearfix uk-list uk-list-collapse uk-flex-column level-1">
																											...
																											<a href="https://test.kraiburg-tpe.com/?searchheader=true&ls=es" class="button-blue" target="_self">Búsqueda de productos</a>
																																																				</li>
								...
								<ul data-region="system" block="block-hauptnavigation" class="menu clearfix uk-list uk-list-collapse uk-flex-column level-1 level-2 uk-hidden" id="submenu22">
																											...
																											<a href="https://www.kraiburg-tpe.com/es/tpe-conductor-termico" data-drupal-link-system-path="node/602">Thermally Conductive TPE</a>
																																					...
																																					<div class="uk-margin-remove ">
																																									<span class="uk-hidden@l"><a href="https://test.kraiburg-tpe.com/?searchheader=true&ls=es" class="button-blue" target="_self">Búsqueda de productos</a></span>
																																								<div>																</div>
																			</div>
																																					<div class="uk-margin-remove ">
								...
								<ul data-region="system" block="block-hauptnavigation" class="menu clearfix uk-list uk-list-collapse uk-flex-column level-1 level-2">
																...
																<div class="uk-accordion">
																																																						...
																																																						<div class="uk-margin-remove ">
																																									<span class="uk-hidden@l"><a href="https://www.kraiburg-tpe.com/es/elast%C3%B3mero-termopl%C3%A1stico" data-drupal-link-system-path="node/1235">Qué son los elastómeros termoplásticos (TPE)</a></span>
																																								<div>																</div>
																			</div>
																																					<div class="uk-margin-remove ">
																																									<span class="uk-hidden@l"><a href="https://www.kraiburg-tpe.com/es/what-tpo-thermoplastic-polyolefins" title="Poliolefinas termoplásticas (TPO)" data-drupal-link-system-path="node/1242">¿Qué es el TPO?</a></span>
																																								<div>																</div>
																			</div>
																																					<div class="uk-margin-remove ">
																																									<span class="uk-hidden@l"><a href="https://www.kraiburg-tpe.com/es/what-tpa-material-thermoplastic-polyamide-elastomers" title="Elastómeros termoplásticos de poliamida (TPA)" data-drupal-link-system-path="node/1239">¿Qué es el material TPA?</a></span>
																																								<div>																</div>
																			</div>
																																					<div class="uk-margin-remove ">
																																									<span class="uk-hidden@l"><a href="https://www.kraiburg-tpe.com/es/what-tpc-material-thermoplastic-polyester-elastomers" title="Elastómeros de poliéster termoplástico (TPC)" data-drupal-link-system-path="node/1241">¿Qué es el material TPC?</a></span>
																																								<div>																</div>
																			</div>
																																					<div class="uk-margin-remove ">
																																									<span class="uk-hidden@l"><a href="https://www.kraiburg-tpe.com/es/what-tpu-thermoplastic-polyurethane" title="Poliuretanos termoplásticos (TPU)" data-drupal-link-system-path="node/1243">¿Qué es el material TPU?</a></span>
																																								<div>																</div>
																			</div>
																																					<div class="uk-margin-remove ">
																																									<span class="uk-hidden@l"><a href="https://www.kraiburg-tpe.com/es/what-does-tps-stand-thermoplastic-styrene-block-copolymers" title="Copolímeros de bloques de estireno termoplásticos (TPS)" data-drupal-link-system-path="node/1238">¿Qué significa TPS?</a></span>
																																								<div>																</div>
																			</div>
																																					<div class="uk-margin-remove ">
																																									<span class="uk-hidden@l"><a href="https://www.kraiburg-tpe.com/es/what-are-tpv-thermoplastic-vulcanizates" title="Termoplásticos Vulcanizados (TPV)" data-drupal-link-system-path="node/1237">¿Qué son los TPV?</a></span>
																																								<div>																</div>
																			</div>
																																																			</div>
																																</div>
