	...
	<div id="block-newsletter" class="block block-block-content block-block-contentf46abdf7-f4a7-4489-b1de-4436a13176b4 uk-width-1-1">
		<div class="paragraph clearfix paragraph--type--section paragraph--view-mode--default row section-bottom-space-big color-scheme-transparent">
			<div class="paragraph clearfix paragraph--type--mediabox paragraph--view-mode--default color-scheme-blue light-font-definition uk-width-1-1 content-links" data-href="https://web.inxmail.com/kraiburg-tpe/en/newsletter.jsp">
	...
	<p class="copy-text-bold">STAY UP TO DATE</p>
<p class="copy-text">Subscribe to our Newsletter</p>

</div>
							<div class="content uk-width-5-12@s uk-width-4-12@m">
								<a href="https://web.inxmail.com/kraiburg-tpe/en/newsletter.jsp" class="readmore">Request Newsletter</a>
							</div>
						</div>
					</div>
				</div>
  ...
  <h2 id="block-04footerquicklinks1-menu">Product</h2>
							...
							<ul block="block-04footerquicklinks1" class="menu clearfix uk-list uk-list-collapse">
															...
															<a href="https://www.kraiburg-tpe.com/pl/node/26" data-drupal-link-system-path="node/26">Rozwiązania produktowe</a>
																																					...
																																					<li data-grid-fullwidth="0" class="level-0">
															<a href="https://pdb.kraiburg-tpe.com/?searchheader=true&ls=en">Wyszukiwarka produktów</a>
																				</li>
												</ul>
  ...
  <h2 id="block-05footerquicklinks2-menu">News &amp; Media</h2>
							...
							<ul block="block-05footerquicklinks2" class="menu clearfix uk-list uk-list-collapse">
																																			<li data-grid-fullwidth="0" class="level-0">
															<a href="https://www.kraiburg-tpe.com/pl/node/67" data-drupal-link-system-path="node/67">Press</a>
																				</li>
																																					<li data-grid-fullwidth="0" class="level-0">
															<a href="https://www.kraiburg-tpe.com/pl/node/10" data-drupal-link-system-path="node/10">Blog</a>
																				</li>
																																					<li data-grid-fullwidth="0" class="level-0">
  ...
  <h2 id="block-06footerquicklinks3-menu">Company</h2>
							...
							<ul block="block-06footerquicklinks3" class="menu clearfix uk-list uk-list-collapse">
																																			<li data-grid-fullwidth="0" class="level-0">
															<a href="https://www.kraiburg-tpe.com/pl/node/18" data-drupal-link-system-path="node/18">Kariera</a>
																				</li>
																																					<li data-grid-fullwidth="0" class="level-0">
															<a href="https://www.kraiburg-tpe.com/pl/node/46" data-drupal-link-system-path="node/46">O nas</a>
																				</li>
																																					<li class="level-0">
															<a href="https://www.kraiburg-tpe.com/pl/node/51" data-drupal-link-system-path="node/51">Code of Conduct</a>
																				</li>
																																					<li class="level-0">
															<a href="https://www.kraiburg-tpe.com/pl/node/5" data-drupal-link-system-path="node/5">Nasze atuty</a>
																				</li>
																																					<li class="level-0">
															<a href="https://www.kraiburg-tpe.com/pl/node/49" data-drupal-link-system-path="node/49">Compliance</a>
																				</li>
																																					<li class="level-0">
															<a href="https://www.kraiburg-tpe.com/pl/node/11" data-drupal-link-system-path="node/11">Kontakt</a>
																				</li>
												</ul>
...
<div class="js-view-dom-id-6b3cf8446b2eb864b3ec58c4c6b4854871c4949abef4977d23c980e9445bf147">
  
  
  

  
  <form class="views-exposed-form bef-exposed-form" data-bef-auto-submit="" data-bef-auto-submit-delay="500" data-bef-auto-submit-minimum-length="3" data-bef-auto-submit-full-form="" data-drupal-selector="views-exposed-form-footer-locations-block-1" action="/pl/node/63" method="get" id="views-exposed-form-footer-locations-block-1" accept-charset="UTF-8">
...
<button data-bef-auto-submit-click="" class="js-hide button_submit button js-form-submit form-submit kbtpe-icon-action-button" data-twig-suggestion="button_submit" data-drupal-selector="edit-submit-footer-locations" type="submit" id="edit-submit-footer-locations" value="ajaxAnwenden">Send</button>
...
<a class="small-font" href="https://maps.google.de/maps?dirflg=d&amp;daddr=15%20Vicars%20Place%2C%20Wetherill%20Park%20NSW%202164%2C%20Australia" target="_blank">APN Plastics Pty Ltd. - Australia, Melbourne - Australia, 15 Vicars Place, Wetherill Park NSW 2164, Australia</a></span></div>
					...
					<a href="#" id="scroll-to-top" data-uk-totop data-uk-scroll>Back to top</a>
				</div>
  ...
  <h2 class="visually-hidden" id="block-07footerlegals-menu">07 Footer Legals</h2>
							...
							<ul block="block-07footerlegals" class="menu clearfix uk-list uk-list-collapse">
																																																															<li data-grid-fullwidth="0" class="level-0">
															<a href="https://www.kraiburg-tpe.com/pl/sitemap" data-drupal-link-system-path="sitemap">Sitemap</a>
																				</li>
																																					<li class="level-0">
															<a href="https://www.kraiburg-tpe.com/pl/node/55" data-drupal-link-system-path="node/55">Terms &amp; Conditions</a>
																				</li>
																																					<li class="level-0">
															<a href="https://www.kraiburg-tpe.com/pl/node/53" data-drupal-link-system-path="node/53">Legal notice</a>
																				</li>
																																					<li class="level-0">
															<a href="https://www.kraiburg-tpe.com/pl/node/54" data-drupal-link-system-path="node/54">Polityka prywatności</a>
																				</li>
																																					<li data-grid-fullwidth="0" class="level-0">
  ...
  <h2 class="visually-hidden" id="block-08footericonlinks-menu">08 Footer Iconlinks</h2>
							...
							<ul block="block-08footericonlinks" class="menu clearfix uk-list uk-list-collapse">
															...
															<a href="https://blog.naver.com/kraiburgtpe_2015" class="nolink kbtpe-icon-naver" aria-label="Naver" target="_blank" title="Naver"></a>
																																					...
																																					<li data-grid-fullwidth="0" class="level-0">
															<a href="https://www.kraiburg-tpe.com/pl/node/250" class="nolink kbtpe-icon-wechat" aria-label="Wechat" target="_blank" title="Wechat" data-drupal-link-system-path="node/250"></a>
																				</li>
												</ul>
  ...
  <h2 id="block-werkzeuge-menu">Werkzeuge</h2>
							...
							<ul block="block-werkzeuge" class="menu clearfix uk-list uk-list-collapse">
															...
															<a href="#sliding-popup" onclick="if (Drupal.eu_cookie_compliance) { Drupal.eu_cookie_compliance.toggleWithdrawBanner(); } return false;" class="eu-cookie-compliance-toggle-withdraw-banner" title="Toggle the cookie consent settings tray">Cookie settings</a>
																																					...
																																					<li class="level-0">
															<a href="https://www.kraiburg-tpe.com/pl/sitemap" data-drupal-link-system-path="sitemap">Mapa witryny</a>
																				</li>
												</ul>
		...
		<div class="hidden" id="multilanguage-strings">
			<span id="ktpe_switch_on">On</span> 			<span id="ktpe_switch_off">Off</span> 			<span id="ktpe_region">Region</span> 							<span id="ktpe_artikel">Article</span>
							<span id="ktpe_download">Download</span>
							<span id="ktpe_event">Event</span>
							<span id="ktpe_glossary_term">ktpe_glossary_term</span>
							<span id="ktpe_knowledge">ktpe_knowledge</span>
							<span id="ktpe_news">News</span>
							<span id="ktpe_press">Press</span>
					</div>
...
<script src="https://www.kraiburg-tpe.com/sites/default/files/js/js_n-xU4b_q7xZkb8m1sA32uoN1W2Wbi1svNebp5SHZlDY.js?scope=footer&amp;delta=3&amp;language=pl&amp;theme=schnitzraum&amp;include=eJx1kU1uxCAMhS-EwhnaVRftqgdABt4EtwQjcDqZnr5kNtORko1_3mfZlk1ftLksFNEsPeJJUxPv0YyHKprDVqUjugvnkXZLq4rrq19Yz0pmFDTKBqsLIt-M4ZaamUqAPRJNTaLSr1xhH-HEZczoFBcu9iIyek9ZAilL6dMM4Wp6SKPot9G6WCq8kOINPCd9InMWP_b5L1VqNDeq6SUEaRFSjvHrqnrG3rnrD-N6TD8QmbxszzT6T71lmA5qITmq7PaL3m8BhT3RzT6n27ud9nf9Afrbskc"></script>
