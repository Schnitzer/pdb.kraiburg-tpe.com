...
<div class="js-view-dom-id-7578a6b8c7c9df7e0f58264d19db7415298c6a264fc6672e4234bb2f8ce3eeb9 clearfix">
	...
	<div>
		<form class="views-exposed-form bef-exposed-form" data-bef-auto-submit="" data-bef-auto-submit-delay="500" data-bef-auto-submit-minimum-length="3" data-bef-auto-submit-full-form="" data-drupal-selector="views-exposed-form-search-block-1" action="/pl/node/63" method="get" id="views-exposed-form-search-block-1" accept-charset="UTF-8">
...
<div class="uk-margin">
	<div class="uk-inline uk-width-1-1">
		...
		<input data-drupal-selector="edit-search" data-search-api-autocomplete-search="search" class="form-autocomplete form-text uk-input" data-autocomplete-path="/pl/search_api_autocomplete/search?display=block_1&amp;&amp;filter=search" type="text" id="edit-search" name="search" value="" size="30" maxlength="128" placeholder="Wyszukiwanie"/>
	</div>
</div>
...
<div class="js-form-item form-item js-form-type-radio form-type-radio js-form-item-type form-item-type">
				...
				<label for="edit-type-artikel" class="option">Artykuł</label>
					<div>
...
<div class="js-form-item form-item js-form-type-radio form-type-radio js-form-item-type form-item-type">
				...
				<label for="edit-type-event" class="option">Wydarzenia</label>
					<div>
...
<div class="js-form-item form-item js-form-type-radio form-type-radio js-form-item-type form-item-type">
				...
				<label for="edit-type-news" class="option">Aktualności</label>
					<div>
...
<div class="js-form-item form-item js-form-type-radio form-type-radio js-form-item-type form-item-type">
				...
				<label for="edit-type-press" class="option">Prasa</label>
					<div>
	...
	<div class="js-form-item form-item js-form-type-radio form-type-radio js-form-item-type form-item-type">
		<a href="https://pdb.kraiburg-tpe.com" target="_blank" class="label" uk-icon="chevron-right">Wyszukiwarka produktów</a>
		<div></div>
</div>
...
<button data-bef-auto-submit-click="" class="js-hide button_submit button js-form-submit form-submit kbtpe-icon-action-button" data-twig-suggestion="button_submit" data-drupal-selector="edit-submit-search" type="submit" id="edit-submit-search" value="Anwenden">Send</button>
	...
	<header role="banner" id="header-container" class="mediumspace-wrapper">
		<div class="uk-flex">
			<div id="header-container--logo">
				<a href="https://www.kraiburg-tpe.com/pl">
  ...
  <h2 class="visually-hidden" id="block-headerquicklinks-menu">Quicklinks</h2>
							...
							<ul block="block-headerquicklinks" class="menu clearfix uk-list uk-list-collapse">
															...
															<a href="https://www.kraiburg-tpe.com/pl/node/11" class="quicklinks-contact" data-drupal-link-system-path="node/11">Kontakt</a>
																				</li>
																																					<li data-grid-fullwidth="0" class="level-0">
															<a href="https://pdb.kraiburg-tpe.com/?searchheader=true&ls=pl" class="pdb-linksource" target="_self">Wyszukiwarka produktów</a>
																				</li>
												</ul>
...
<nav class="uk-navbar-container uk-navbar-transparent">
		...
		<div data-uk-navbar="dropbar: true; dropbar-anchor: !.uk-navbar-container; target-y: !.uk-navbar-container; mode: click" class="uk-flex-center uk-navbar">
											...
											<div>
														<ul data-region="system" block="block-hauptnavigation" class="menu clearfix uk-navbar-nav uk-list uk-list-collapse">
																											...
																											<a href="https://www.kraiburg-tpe.com/pl" class="hidden-lg" data-drupal-link-system-path="&lt;front&gt;">Home</a>
																																																				</li>
								...
								<ul data-region="system" block="block-hauptnavigation" class="menu clearfix uk-list uk-list-collapse uk-flex-column level-1">
																											...
																											<a href="https://www.kraiburg-tpe.com/pl/node/26" data-drupal-link-system-path="node/26">Rozwiązania produktowe</a>
																																																				</li>
																											...
																											<a href="https://www.kraiburg-tpe.com/pl/node/24" data-drupal-link-system-path="node/24">Cechy produktu</a>
																																																				</li>

																																						
																																																																																	<li data-grid-fullwidth="0" class="active-li uk-position-relative uk-text-left level-1">
																											<a href="https://pdb.kraiburg-tpe.com/?searchheader=true&ls=pl" class="button-blue" target="_self">Wyszukiwarka produktów</a>
																																																				</li>

																																						
																																																																																	<li class="uk-position-relative uk-text-left level-1">
																											<a href="https://www.kraiburg-tpe.com/pl/node/767" data-drupal-link-system-path="node/767">Blow-Fill-Seal Technology</a>
																																																				</li>
																...
																<div class="uk-accordion">
																																									...
																																									<a class="uk-accordion-title uk-hidden@l">Rozwiązania produktowe</a>
																																								<div>												
								...
								<ul data-region="system" block="block-hauptnavigation" class="menu clearfix uk-list uk-list-collapse uk-flex-column level-1 level-2" id="submenu21">
																											...
																											<a href="https://www.kraiburg-tpe.com/pl/node/85" title="TPE for multiple applications in the automotive, consumer and industrial markets." data-drupal-link-system-path="node/85">THERMOLAST® K</a>
																													<span>
	<p class="copy-text" style="color:#666666;"><span class="text-small">TPE for multiple applications in the automotive, consumer and industrial markets</span></p>
																											...
																											<a href="https://www.kraiburg-tpe.com/pl/node