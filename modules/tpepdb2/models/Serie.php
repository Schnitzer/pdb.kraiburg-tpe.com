...
class Tpepdb2_Serie extends TpePdbModel {
     ...
     *
     */
    public function searchViaProperties ($market, $application, $advantage, $language, $region_id = null, $with_template = true, $language_id, $search_in_values = false, $found_series = array()) {
        $conditions = array();
