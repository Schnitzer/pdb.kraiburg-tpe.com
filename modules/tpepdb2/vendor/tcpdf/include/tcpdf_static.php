...
class TCPDF_STATIC
{
	...
	public static function getPageSizeFromFormat($format)
	{
		...
		switch (strtoupper($format)) {
			...
			case 'A1':
				{
					$pf = array(1683.78, 2383.937);
					break;
				}
			case 'A2':
				{
					$pf = array(1190.551, 1683.78);
					break;
				}
			case 'A3':
				{
					$pf = array(841.89, 1190.551);
					break;
				}
			case 'A4':
				{
					$pf = array(595.276, 841.89);
					break;
				}
			case 'A5':
				{
			...
			case 'B3':
				{
					$pf = array(1000.63, 1417.323);
					break;
				}
			case 'B4':
				{
					$pf = array(708.661, 1000.63);
					break;
				}
			case 'B5':
				{
			...
			case 'B12':
				{
					$pf = array(42.52, 62.362);
					break;
				}
				// ISO 216 C Series + 2 SIS 014711 extensions + 2 EXTENSION
			case 'C0':
				{
					$pf = array(2599.37, 3676.535);
					break;
				}
			case 'C1':
				{
					$pf = array(1836.85, 2599.37);
					break;
				}
			case 'C2':
				{
					$pf = array(1298.268, 1836.85);
					break;
				}
			case 'C3':
				{
			...
			case 'C6':
				{
					$pf = array(323.15, 459.213);
					break;
				}
			case 'C7':
				{
					$pf = array(229.606, 323.15);
					break;
				}
			case 'C8':
				{
			...
			case 'C10':
				{
					$pf = array(79.37, 113.386);
					break;
				}
			case 'C11':
				{
					$pf = array(56.693, 79.37);
					break;
				}
			case 'C12':
				{
			...
			case 'E1':
				{
					$pf = array(1757.48, 2491.654);
					break;
				}
			case 'E2':
				{
					$pf = array(1247.244, 1757.48);
					break;
				}
			case 'E3':
				{
					$pf = array(878.74, 1247.244);
					break;
				}
			case 'E4':
				{
					$pf = array(623.622, 878.74);
					break;
				}
			case 'E5':
				{
					$pf = array(439.37, 623.622);
					break;
				}
			case 'E6':
				{
					$pf = array(311.811, 439.37);
					break;
				}
			case 'E7':
				{
			...
			case 'E12':
				{
					$pf = array(36.85, 53.858);
					break;
				}
				// SIS 014711 G Series
			case 'G0':
				{
					$pf = array(2715.591, 3838.11);
					break;
				}
			case 'G1':
				{
			...
			case 'G3':
				{
					$pf = array(958.11, 1357.795);
					break;
				}
			case 'G4':
				{
					$pf = array(677.48, 958.11);
					break;
				}
			case 'G5':
				{
					$pf = array(479.055, 677.48);
					break;
				}
			case 'G6':
				{
			...
			case 'G7':
				{
					$pf = array(238.11, 337.323);
					break;
				}
			case 'G8':
				{
					$pf = array(167.244, 238.11);
					break;
				}
			case 'G9':
				{
			...
			case 'ANSI_E':
				{
					$pf = array(2448.0, 3168.0);
					break;
				}
			case 'ANSI_D':
				{
					$pf = array(1584.0, 2448.0);
					break;
				}
			case 'ANSI_C':
				{
					$pf = array(1224.0, 1584.0);
					break;
				}
			case 'ANSI_B':
				{
					$pf = array(792.0, 1224.0);
					break;
				}
			case 'ANSI_A':
				{
					$pf = array(612.0, 792.0);
					break;
				}
			...
			case 'LEGAL':
				{
					$pf = array(612.0, 1008.0);
					break;
				}
			case 'GOVERNMENTLETTER':
			case 'GLETTER':
				{
					$pf = array(576.0, 756.0);
					break;
				}
			case 'JUNIORLEGAL':
			case 'JLEGAL':
				{
					$pf = array(576.0, 360.0);
					break;
				}
				// Other North American Paper Sizes
			case 'QUADDEMY':
				{
					$pf = array(2520.0, 3240.0);
					break;
				}
			case 'SUPER_B':
				{
					$pf = array(936.0, 1368.0);
					break;
				}
			case 'QUARTO':
				{
					$pf = array(648.0, 792.0);
					break;
				}
			case 'GOVERNMENTLEGAL':
			case 'FOLIO':
				{
					$pf = array(612.0, 936.0);
					break;
				}
			case 'MONARCH':
			case 'EXECUTIVE':
				{
					$pf = array(522.0, 756.0);
					break;
				}
			case 'ORGANIZERL':
			case 'STATEMENT':
			case 'MEMO':
				{
					$pf = array(396.0, 612.0);
					break;
				}
			case 'FOOLSCAP':
				{
					$pf = array(595.44, 936.0);
					break;
				}
			case 'COMPACT':
				{
					$pf = array(306.0, 486.0);
					break;
				}
			case 'ORGANIZERJ':
				{
					$pf = array(198.0, 360.0);
					break;
				}
			...
			case 'P5':
				{
					$pf = array(396.85, 609.449);
					break;
				}
			case 'P6':
				{
					$pf = array(303.307, 396.85);
					break;
				}
				// North American Architectural Sizes
			case 'ARCH_E':
				{
					$pf = array(2592.0, 3456.0);
					break;
				}
			case 'ARCH_E1':
				{
					$pf = array(2160.0, 3024.0);
					break;
				}
			case 'ARCH_D':
				{
					$pf = array(1728.0, 2592.0);
					break;
				}
			case 'BROADSHEET':
			case 'ARCH_C':
				{
					$pf = array(1296.0, 1728.0);
					break;
				}
			case 'ARCH_B':
				{
					$pf = array(864.0, 1296.0);
					break;
				}
			case 'ARCH_A':
				{
					$pf = array(648.0, 864.0);
					break;
				}
			...
			case 'ANNENV_A2':
				{
					$pf = array(314.64, 414.0);
					break;
				}
			case 'ANNENV_A6':
				{
					$pf = array(342.0, 468.0);
					break;
				}
			case 'ANNENV_A7':
				{
					$pf = array(378.0, 522.0);
					break;
				}
			case 'ANNENV_A8':
				{
					$pf = array(396.0, 584.64);
					break;
				}
			case 'ANNENV_A10':
				{
					$pf = array(450.0, 692.64);
					break;
				}
			case 'ANNENV_SLIM':
				{
					$pf = array(278.64, 638.64);
					break;
				}
				//   - Commercial Envelopes
			case 'COMMENV_N6_1/4':
				{
					$pf = array(252.0, 432.0);
					break;
				}
			case 'COMMENV_N6_3/4':
				{
					$pf = array(260.64, 468.0);
					break;
				}
			case 'COMMENV_N8':
				{
					$pf = array(278.64, 540.0);
					break;
				}
			case 'COMMENV_N9':
				{
			...
			case 'COMMENV_N10':
				{
					$pf = array(296.64, 684.0);
					break;
				}
			case 'COMMENV_N11':
				{
					$pf = array(324.0, 746.64);
					break;
				}
			case 'COMMENV_N12':
				{
					$pf = array(342.0, 792.0);
					break;
				}
			case 'COMMENV_N14':
				{
					$pf = array(360.0, 828.0);
					break;
				}
				//   - Catalogue Envelopes
			case 'CATENV_N1':
				{
					$pf = array(432.0, 648.0);
					break;
				}
			case 'CATENV_N1_3/4':
				{
					$pf = array(468.0, 684.0);
					break;
				}
			case 'CATENV_N2':
				{
					$pf = array(468.0, 720.0);
					break;
				}
			case 'CATENV_N3':
				{
					$pf = array(504.0, 720.0);
					break;
				}
			case 'CATENV_N6':
				{
					$pf = array(540.0, 756.0);
					break;
				}
			case 'CATENV_N7':
				{
					$pf = array(576.0, 792.0);
					break;
				}
			case 'CATENV_N8':
				{
					$pf = array(594.0, 810.0);
					break;
				}
			case 'CATENV_N9_1/2':
				{
					$pf = array(612.0, 756.0);
					break;
				}
			case 'CATENV_N9_3/4':
				{
					$pf = array(630.0, 810.0);
					break;
				}
			case 'CATENV_N10_1/2':
				{
			...
			case 'CATENV_N12_1/2':
				{
					$pf = array(684.0, 900.0);
					break;
				}
			case 'CATENV_N13_1/2':
				{
					$pf = array(720.0, 936.0);
					break;
				}
			case 'CATENV_N14_1/4':
				{
					$pf = array(810.0, 882.0);
					break;
				}
			case 'CATENV_N14_1/2':
				{
					$pf = array(828.0, 1044.0);
					break;
				}
			...
			case 'PA5':
				{
					$pf = array(396.85, 595.276);
					break;
				}
			case 'PA6':
				{
					$pf = array(297.638, 396.85);
					break;
				}
			case 'PA7':
				{
			...
			case '10R':
				{
					$pf = array(720.0, 864.567);
					break;
				}
			case '4PW':
			case 'S10R':
				{
					$pf = array(720.0, 1080.0);
					break;
				}
			case '11R':
				{
			...
			case '12SHEET':
				{
					$pf = array(8640.0, 4320.0);
					break;
				}
			case '16SHEET':
				{
					$pf = array(5760.0, 8640.0);
					break;
				}
			case '32SHEET':
				{
					$pf = array(11520.0, 8640.0);
					break;
				}
			case '48SHEET':
				{
					$pf = array(17280.0, 8640.0);
					break;
				}
			case '64SHEET':
				{
					$pf = array(23040.0, 8640.0);
					break;
				}
			case '96SHEET':
				{
					$pf = array(34560.0, 8640.0);
					break;
				}
				// Old European Sizes
			...
			case 'EN_EMPEROR':
				{
					$pf = array(3456.0, 5184.0);
					break;
				}
			case 'EN_ANTIQUARIAN':
				{
					$pf = array(2232.0, 3816.0);
					break;
				}
			case 'EN_GRAND_EAGLE':
				{
					$pf = array(2070.0, 3024.0);
					break;
				}
			case 'EN_DOUBLE_ELEPHANT':
				{
					$pf = array(1926.0, 2880.0);
					break;
				}
			case 'EN_ATLAS':
				{
					$pf = array(1872.0, 2448.0);
					break;
				}
			case 'EN_COLOMBIER':
				{
					$pf = array(1692.0, 2484.0);
					break;
				}
			case 'EN_ELEPHANT':
				{
					$pf = array(1656.0, 2016.0);
					break;
				}
			case 'EN_DOUBLE_DEMY':
				{
					$pf = array(1620.0, 2556.0);
					break;
				}
			case 'EN_IMPERIAL':
				{
					$pf = array(1584.0, 2160.0);
					break;
				}
			case 'EN_PRINCESS':
				{
					$pf = array(1548.0, 2016.0);
					break;
				}
			case 'EN_CARTRIDGE':
				{
					$pf = array(1512.0, 1872.0);
					break;
				}
			case 'EN_DOUBLE_LARGE_POST':
				{
					$pf = array(1512.0, 2376.0);
					break;
				}
			case 'EN_ROYAL':
				{
					$pf = array(1440.0, 1800.0);
					break;
				}
			case 'EN_SHEET':
			case 'EN_HALF_POST':
				{
					$pf = array(1404.0, 1692.0);
					break;
				}
			case 'EN_SUPER_ROYAL':
				{
					$pf = array(1368.0, 1944.0);
					break;
				}
			case 'EN_DOUBLE_POST':
				{
					$pf = array(1368.0, 2196.0);
					break;
				}
			case 'EN_MEDIUM':
				{
					$pf = array(1260.0, 1656.0);
					break;
				}
			case 'EN_DEMY':
				{
					$pf = array(1260.0, 1620.0);
					break;
				}
			case 'EN_LARGE_POST':
				{
					$pf = array(1188.0, 1512.0);
					break;
				}
			case 'EN_COPY_DRAUGHT':
				{
					$pf = array(1152.0, 1440.0);
					break;
				}
			case 'EN_POST':
				{
					$pf = array(1116.0, 1386.0);
					break;
				}
			case 'EN_CROWN':
				{
					$pf = array(1080.0, 1440.0);
					break;
				}
			case 'EN_PINCHED_POST':
				{
					$pf = array(1062.0, 1332.0);
					break;
				}
			case 'EN_BRIEF':
				{
					$pf = array(972.0, 1152.0);
					break;
				}
			case 'EN_FOOLSCAP':
				{
					$pf = array(972.0, 1224.0);
					break;
				}
			case 'EN_SMALL_FOOLSCAP':
				{
					$pf = array(954.0, 1188.0);
					break;
				}
			case 'EN_POTT':
				{
					$pf = array(900.0, 1080.0);
					break;
				}
			...
			case 'BE_COLOMBIER':
				{
					$pf = array(1757.48, 2409.449);
					break;
				}
			case 'BE_DOUBLE_CARRE':
				{
					$pf = array(1757.48, 2607.874);
					break;
				}
			case 'BE_ELEPHANT':
				{
			...
			case 'FR_DOUBLE_RAISIN':
				{
					$pf = array(1842.52, 2834.646);
					break;
				}
			case 'FR_JOURNAL':
				{
					$pf = array(1842.52, 2664.567);
					break;
				}
			...
			case 'FR_TELLIERE':
				{
					$pf = array(963.78, 1247.244);
					break;
				}
			case 'FR_POT':
				{
					$pf = array(878.74, 1133.858);
					break;
				}
				// DEFAULT ISO A4
			default:
	...
	{
		// set defaults for PHP 8.1+ compatibility
		if ($limit === NULL) {
			$limit = -1;
		}
		if ($flags === NULL) {
