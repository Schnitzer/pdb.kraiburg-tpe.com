...
FROM ncw_tpepdb2_compound WHERE serie_id = '" . $series_id . "'";
    ...
    public function sucheAction ()
    {
        ...
        //$language_id = (int) $_GET["l"];
				...
				foreach ($this->params['url'] As $key => $item) {
					...
					if (false == in_array($key, $arr_not) && strlen($this->params['url']['pdb2_search']) < 1) {
						...
						// Insert term Suchbegriff speichern
								...
								$str_insert_wcms_search = "INSERT INTO ncw_wcms_search (checkbox, lang, modified) VALUES ('" . $str_internal_ids_all . "', '" . $str_lang . "', '" . date('Y-m-d H:i:s') . "')";
								$db = Ncw_Database::getInstance();
					...
					if ($key == 'pdb2_search' && strlen($this->params['url']['pdb2_search']) > 1) {
						...
						// Insert term Suchbegriff speichern
						$str_lang = Ncw_Library_Sanitizer::escape($_GET["l"]);
						$str_insert_wcms_search = "INSERT INTO ncw_wcms_search (term, lang, modified) VALUES ('" . $str_search . "', '" . $str_lang . "', '" . date('Y-m-d H:i:s') . "')";
			...
			if ( true == isset($this->params['url']['c_10']) ||  true == isset($this->params['url']['c_11']) || true == isset($this->params['url']['c_12']) || true == isset($this->params['url']['c_13']) ) {
				...
				if (true == isset($this->params['url']['c_10'])) {
					$str_lang = Ncw_Library_Sanitizer::escape($_GET["l"]);
					$str_insert_wcms_search = "INSERT INTO ncw_wcms_search (checkbox, type, lang, modified) VALUES ('" . $this->params['url']['c_10'] . "', 'color', '" . $str_lang . "', '" . date('Y-m-d H:i:s') . "')";
	//echo $str_insert_wcms_search;
				...
				if (true == isset($this->params['url']['c_11'])) {
					$str_lang = Ncw_Library_Sanitizer::escape($_GET["l"]);
					$str_insert_wcms_search = "INSERT INTO ncw_wcms_search (checkbox, type, lang, modified) VALUES ('" . $this->params['url']['c_11'] . "', 'color', '" . $str_lang . "', '" . date('Y-m-d H:i:s') . "')";
	//echo $str_insert_wcms_search;
					$db = Ncw_Database::getInstance();
					$sth = $db->prepare( $str_insert_wcms_search);
					$sth->execute();
				...
				if (true == isset($this->params['url']['c_12'])) {
					$str_lang = Ncw_Library_Sanitizer::escape($_GET["l"]);
					$str_insert_wcms_search = "INSERT INTO ncw_wcms_search (checkbox, type, lang, modified) VALUES ('" . $this->params['url']['c_12'] . "', 'color', '" . $str_lang . "', '" . date('Y-m-d H:i:s') . "')";
	//echo $str_insert_wcms_search;
					$db = Ncw_Database::getInstance();
					$sth = $db->prepare( $str_insert_wcms_search);
					$sth->execute();
				...
				if (true == isset($this->params['url']['c_13'])) {
					$str_lang = Ncw_Library_Sanitizer::escape($_GET["l"]);
					$str_insert_wcms_search = "INSERT INTO ncw_wcms_search (checkbox, type, lang, modified) VALUES ('" . $this->params['url']['c_13'] . "', 'color', '" . $str_lang . "', '" . date('Y-m-d H:i:s') . "')";
	//echo $str_insert_wcms_search;
					$db = Ncw_Database::getInstance();
					$sth = $db->prepare( $str_insert_wcms_search);
					$sth->execute();
			...
			if ( true == isset($this->params['url']['r_10']) ||  true == isset($this->params['url']['r_11']) ||  true == isset($this->params['url']['r_12'])) {
				...
				// Insert term Suchbegriff speichern
				$str_lang = Ncw_Library_Sanitizer::escape($_GET["l"]);
				$str_insert_wcms_search = "INSERT INTO ncw_wcms_search (checkbox, type, lang, modified) VALUES ('" . $this->params['url']['c_11'] . "', 'region', '" . $str_lang . "', '" . date('Y-m-d H:i:s') . "')";
		...
		*/
		public function getLabelName($str, $str_fallback , $language_id)
		{
			...
			$sth->execute();
			$results = $sth->fetchAll();
			if ( strlen($results[0]['translation']) > 1) {
