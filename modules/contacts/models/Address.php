 ...
 * @package netzcraftwerk
 */
class Contacts_Address extends Ncw_Model
{
     ...
     * @var array
     */
	public $belongs_to = array('Contact', 'City');
    ...
    public $validation = array(
    	...
    	'location' => array('rules' => array('InList' => array('work', 'home', 'other')), 'required' => true),
      	'street' => array('rules' => array('NotEmpty', 'MaxLength' => 255), 'required' => true),
      	'city_id' => array('rules' => array('Integer'), 'required' => true),
