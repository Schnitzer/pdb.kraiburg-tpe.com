 ...
 * @package netzcraftwerk
 */
class Contacts_Date extends Ncw_Model
{
	...
	public $validation = array(
		...
		'description' => array('rules' => array('InList' => array('birthday','anniversary','first met','hired','fired','other')), 'required' => true),
		'date' => array('rules' => array('Date'), 'required' => true),
