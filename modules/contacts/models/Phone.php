...
/* SVN FILE: $Id$ */
/**
 * Contains the Phone model class.
 *
 * PHP Version 5
 ...
 * @package netzcraftwerk
 */
class Contacts_Phone extends Ncw_Model
{
    ...
    public $validation = array(
    	...
    	'location' => array('rules' => array('InList' => array('work','mobile','fax','pager','home','skype','other')), 'required' => true),
        'phone' => array('rules' => array('NotEmpty', 'MaxLength' => 255), 'required' => true),
