 ...
 * @package netzcraftwerk
 */
class Wcms_Sitearea extends Ncw_Model
{
	 ...
	 * @var array
	 */
	public $belongs_to = array('Sitetemplate');
	...
	public $validation = array(
        "sitetemplate_id" => array("rules" => array("Integer"), "required" => true),
